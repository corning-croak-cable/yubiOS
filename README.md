...
```
yubiOS/
├── .github/workflows/           # CI: main build, ARM64 fTPM integration lanes, manifest refresh
...
│   └── fetch-fedora-bootc-manifest.yml # resolves quay.io/fedora/fedora-bootc:45 INDEX digest
├── assets/
