...
|---|---|---|---|---|---|---|
| FM-001 | PAT lacks workflows: write; .github/workflows/*.yml write fails | Contents API PUT returns 403; "Resource not accessible" | ask Jenny to grant workflows:write; do not work around | HIGH | Uncommon | run with narrow-scope PAT; assert pre-flight catches |
