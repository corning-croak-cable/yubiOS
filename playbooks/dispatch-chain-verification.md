...
|---|---|---|---|---|---|---|
| FM-001 | outer dispatcher green masks inner red (PR #150 doctrine) | GET /repos/.../actions/runs/<id> shows inner red | read inner run logs; do not trust outer conclusion | HIGH | Frequent | fault-inject inner failure; assert recipe detects |
