...
|---|---|---|---|---|---|---|
| FM-001 | digest bump playbook itself fails; operator stuck | operator runs playbook; same failure | escalate to on-call; mark playbook as missing stop condition | HIGH | Possible | fault-inject fetch workflow failure; assert recipe escalates |
