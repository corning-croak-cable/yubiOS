...
{
  "lens": "L208",
  "file": "playbooks/hw-device-and-allow-real-u2f.md",
  "hypothesis": "playbooks/hw-device-and-allow-real-u2f.md covers all 9 primitives in the internal-big-picture basis",
