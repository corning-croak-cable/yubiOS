...
|---|---|---|---|---|---|---|
| FM-001 | playbook index stale; playbook removed but indexed | click stale link; 404 | remove from index; lint with directory walk | LOW | Common | delete playbook; assert index lint fails |
