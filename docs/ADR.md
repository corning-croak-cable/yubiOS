...
|---|---|---|---|---|---|---|
| FM-001 | ADR names decision without owner; status unclear | grep ADR-NNN shows no owner; status row missing | amend ADR; assign owner; update status | MEDIUM | Uncommon | create ADR without owner; assert reject |
...
##   "filetype": "md",
##   "hypothesis": "config docs/ADR.md: NSS 8-channel assumption taxonomy (caller / invariant / environment / dependency / system-trust / configuration / domain / toolchain) -- file declares its precondition surface explicitly",
