...
- Read `CITATION.md` end-to-end against this section's claim.
...
```
L1500 -- CITATION.md
  hypothesis:  Adjacent-problems awareness on docs/CITATION.md closes the NSS cycle-13 gap (related problems + alternatives + prior art + flip conditions)
