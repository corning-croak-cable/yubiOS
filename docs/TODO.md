...
```json
L3048 -- docs/TODO.md
  hypothesis:  config docs/TODO.md: NSS 7-relation composition taxonomy (contains / imports / calls / publishes / subscribes / reads / writes / deploys-with / depends-on) -- file declares its in-graph and out-graph surface explicitly
...
- Callers: README.md, refs/decisions-deferrals-rejected-models-2026-07-25.md, the BLOCKERS reviewer.
Callees: refs/*.md; sibling: docs/BLOCKERS.md (reviewed same-day gate per PROJECT_RULES.md).
