...
```json
L3045 -- docs/OPTS.md
  hypothesis:  config docs/OPTS.md: NSS 7-relation composition taxonomy (contains / imports / calls / publishes / subscribes / reads / writes / deploys-with / depends-on) -- file declares its in-graph and out-graph surface explicitly
...
- Callers: docs/PLAN.md, docs/ARCHITECTURE.md, SKILL.md.
Callees: ADR refs; sibling: docs/SPEC.md.
