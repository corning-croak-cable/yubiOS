...
|---|---|---|---|---|---|---|
| FM-001 | architecture stale; module removed but doc not updated | grep architecture for module names; mismatch with code | update or delete stale sections; review-after stamp | MEDIUM | Possible | set review_after to past; assert CI fails |
...
##   "filetype": "md",
##   "hypothesis": "config docs/ARCHITECTURE.md: NSS 8-channel assumption taxonomy (caller / invariant / environment / dependency / system-trust / configuration / domain / toolchain) -- file declares its precondition surface explicitly",
...
```json
L3044 -- docs/ARCHITECTURE.md
  hypothesis:  config docs/ARCHITECTURE.md: NSS 7-relation composition taxonomy (contains / imports / calls / publishes / subscribes / reads / writes / deploys-with / depends-on) -- file declares its in-graph and out-graph surface explicitly
...
- Callers: SKILL.md, README.md, docs/THREAT_MODEL.md, docs/ADR.md, the bootc-images skill.
Callees: ADR-NNN refs inline; sibling: docs/CI_MAP.md, docs/SER.md, docs/PLAN.md.
