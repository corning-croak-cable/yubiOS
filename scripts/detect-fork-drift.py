...
# {
#   "lens": "L3018",
#   "file": "scripts/detect-fork-drift.py",
#   "nss_axis": "assumption_set",
#   "primitive_added": "inputs",
#   "filetype": "py",
#   "hypothesis": "config scripts/detect-fork-drift.py: NSS 8-channel assumption taxonomy (caller / invariant / environment / dependency / system-trust / configuration / domain / toolchain) -- file declares its precondition surface explicitly",
