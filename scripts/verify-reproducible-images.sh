...
#   "filetype": "sh",
#   "hypothesis": "config scripts/verify-reproducible-images.sh: NSS 8-channel assumption taxonomy (caller / invariant / environment / dependency / system-trust / configuration / domain / toolchain) -- file declares its precondition surface explicitly",
