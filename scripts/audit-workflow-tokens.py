...
# {
#   "lens": "L3016",
#   "file": "scripts/audit-workflow-tokens.py",
#   "nss_axis": "assumption_set",
#   "primitive_added": "inputs",
#   "filetype": "py",
#   "hypothesis": "config scripts/audit-workflow-tokens.py: NSS 8-channel assumption taxonomy (caller / invariant / environment / dependency / system-trust / configuration / domain / toolchain) -- file declares its precondition surface explicitly",
