...
```python
"""
L1528 -- manifest-filesystem.py
  hypothesis:  Adjacent-problems awareness on scripts/lib/manifest-filesystem.py (Python): related pytest/argparse idioms, alternative execution paths, prior-art references
