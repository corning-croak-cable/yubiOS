...
readonly LOCAL_EDK2_REF='b7a715f7c03c45c6b4575bf88596bfd79658b8ce'
...
{
  "lens": "L352",
  "file": "scripts/lib/local-build-firmware.sh",
  "hypothesis": "scripts/lib/local-build-firmware.sh covers all 9 primitives in the internal-big-picture basis",
