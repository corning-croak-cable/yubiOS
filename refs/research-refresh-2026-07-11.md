...
- Reading `research-refresh-2026-07-11.md` (no args) shows usage
...
- Spot-check by reading `research-refresh-2026-07-11.md` end-to-end against this section's claim
