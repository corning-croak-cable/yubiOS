...
```
L1513 -- curve-guided-rsi-and-self-differential-2026-08-04.md
  hypothesis:  Adjacent-problems awareness on refs/curve-guided-rsi-and-self-differential-2026-08-04.md closes the NSS cycle-13 gap (related problems + alternatives + prior art + flip conditions)
