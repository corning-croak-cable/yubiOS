...
- Reading `external-benchmarks-sources-2026-07-26.md` (no args) shows usage
- See `docs/ARCHITECTURE.md` for where this file fits in yubiOS


## Verification

- Spot-check by reading `external-benchmarks-sources-2026-07-26.md` end-to-end against this section's claim
