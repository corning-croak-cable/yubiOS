...
- Reading `arxiv-2607.09967-vs-learned-latent-curve-2026-08-04.md` (no args) shows usage
...
- Spot-check by reading `arxiv-2607.09967-vs-learned-latent-curve-2026-08-04.md` end-to-end against this section's claim
