...
- Reading `mkosi-bcvk-fork-status-2026-07-23.md` (no args) shows usage
...
- Spot-check by reading `mkosi-bcvk-fork-status-2026-07-23.md` end-to-end against this section's claim
