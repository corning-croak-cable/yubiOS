...
```json
L3053 -- refs/external-benchmarks-sources-2026-07-25.md
  hypothesis:  config refs/external-benchmarks-sources-2026-07-25.md: NSS 7-relation composition taxonomy (contains / imports / calls / publishes / subscribes / reads / writes / deploys-with / depends-on) -- file declares its in-graph and out-graph surface explicitly
...
- Callers: docs/CI_MAP.md, docs/PLAN.md, refs/customer-roi-model-2026-07-25.md.
Callees: vendor benchmark URLs; sibling: refs/external-benchmarks-sources-2026-07-26.md.
