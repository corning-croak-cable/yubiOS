...
- **Validation note:** this refines the "~$25-70/device" figure already used in refs/pilot-collateral-roi-baseline-2026-07-25.md (OMN-84, PR #113). The lower bound in that doc appears stale or was citing a bulk/enterprise price not confirmed here; OMN-84’s worksheot should be revisited to reconcile the $58-85 retail range found in this pass against whatever produced the $25 floor, since this doc cannot confirm a $25 price point at official retail.
...
- The $25 floor for YubiKey hardware cost in OMN-84’s worksheet (PR #113) could not be reconciled against official retail pricing found here ($58 floor) -- flagged for OMN-84’s owner to revisit, not silently corrected in this doc.
