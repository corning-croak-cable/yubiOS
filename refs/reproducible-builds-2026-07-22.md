...
```json
L3058 -- refs/reproducible-builds-2026-07-22.md
  hypothesis:  config refs/reproducible-builds-2026-07-22.md: NSS 7-relation composition taxonomy (contains / imports / calls / publishes / subscribes / reads / writes / deploys-with / depends-on) -- file declares its in-graph and out-graph surface explicitly
...
- Callers: docs/ARCHITECTURE.md, scripts/verify-reproducible-images.sh.
Callees: bit-for-bit reproducer docs; sibling: refs/yubios-reproducibility-equivalents-2026-07-30.md.
