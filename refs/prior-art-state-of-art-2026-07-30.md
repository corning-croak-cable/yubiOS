...
- Reading `prior-art-state-of-art-2026-07-30.md` (no args) shows the help text.
...
```json
L3057 -- refs/prior-art-state-of-art-2026-07-30.md
  hypothesis:  config refs/prior-art-state-of-art-2026-07-30.md: NSS 7-relation composition taxonomy (contains / imports / calls / publishes / subscribes / reads / writes / deploys-with / depends-on) -- file declares its in-graph and out-graph surface explicitly
...
- Callers: refs/prior-art-search-rsi-audit-2026-07-30.md, the prior-art-search skill.
Callees: prior-art citations; sibling: refs/prior-art-autonomous-ideation-skill-2026-07-28.md.
