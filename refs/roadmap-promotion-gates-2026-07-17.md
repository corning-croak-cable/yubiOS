...
- Reading `roadmap-promotion-gates-2026-07-17.md` (no args) shows usage
...
- Spot-check by reading `roadmap-promotion-gates-2026-07-17.md` end-to-end against this section's claim
