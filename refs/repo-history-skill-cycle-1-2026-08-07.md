...
- Reading `repo-history-skill-cycle-1-2026-08-07.md` (no args) shows usage
...
- Spot-check by reading `repo-history-skill-cycle-1-2026-08-07.md` end-to-end against this section's claim
