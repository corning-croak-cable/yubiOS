...
```
L1510 -- slsa-l3-sbom-cosign-integration-spec-2026-08-04.md
  hypothesis:  Adjacent-problems awareness on refs/slsa-l3-sbom-cosign-integration-spec-2026-08-04.md closes the NSS cycle-13 gap (related problems + alternatives + prior art + flip conditions)
