...
- Reading `days-0-30-safe-offer-2026-07-25.md` (no args) shows usage
- See `docs/ARCHITECTURE.md` for where this file fits in yubiOS


## Verification

- Spot-check by reading `days-0-30-safe-offer-2026-07-25.md` end-to-end against this section's claim
