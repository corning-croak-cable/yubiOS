...
- Read `covenant-conflict-policy-2026-07-25.md` end-to-end against this section's claim.
...
|---|---|---|---|---|---|---|
| FM-001 | covenant policy conflicts with new contributor license; friction | PR bot flags CLA mismatch; merge blocked | update covenant or migrate CLAs | MEDIUM | Possible | add CLA; assert covenant mismatch flagged |
