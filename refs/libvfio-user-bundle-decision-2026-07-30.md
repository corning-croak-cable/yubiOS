...
- Reading `libvfio-user-bundle-decision-2026-07-30.md` (no args) shows usage
...
- Spot-check by reading `libvfio-user-bundle-decision-2026-07-30.md` end-to-end against this section's claim
