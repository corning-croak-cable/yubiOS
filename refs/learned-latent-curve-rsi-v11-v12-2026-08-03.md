...
This file's lens is **L430** in `lenses.json` (score 17/50, verdict **NO**, k=3/9). Full experiment: hypothesis `refs/learned-latent-curve-rsi-v11-v12-2026-08-03.md covers all 9 primitives in the internal-big-picture basis`, method `9-D primitive binarization (purpose, examples, guidelines, constraints, verifica...`. See root `new-ideas-2026-08-12.md` for the cycle-3 summary.
