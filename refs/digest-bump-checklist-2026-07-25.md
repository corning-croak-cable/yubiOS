...
- Reading `digest-bump-checklist-2026-07-25.md` (no args) shows usage
- See `docs/ARCHITECTURE.md` for where this file fits in yubiOS


## Verification

- Spot-check by reading `digest-bump-checklist-2026-07-25.md` end-to-end against this section's claim
