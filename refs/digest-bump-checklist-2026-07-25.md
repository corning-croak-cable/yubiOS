...
|---|---|---|---|---|---|---|
| FM-001 | checklist references workflow that was renamed | grep checklist for old name; existence check fails | update checklist; remove dead refs | LOW | Common | rename workflow; assert lint fails |
