...
- Reading `luks-fido2-e2e-test-2026-07-23.md` (no args) shows the help text.
...
```
L1509 -- luks-fido2-e2e-test-2026-07-23.md
  hypothesis:  Adjacent-problems awareness on refs/luks-fido2-e2e-test-2026-07-23.md closes the NSS cycle-13 gap (related problems + alternatives + prior art + flip conditions)
