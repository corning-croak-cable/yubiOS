...
- Reading `adr-033-misbehavior-cutoff-policy-2026-07-28.md` (no args) shows the help text.
...
|---|---|---|---|---|---|---|
| FM-001 | ADR-033 misbehavior-triggered cutoff hardware-gate is post-launch | PCI mediation cutoff soft-only; no hardware enforcement | mark in BLOCKERS.md; track via OMN-108 / OMN-144-147 | HIGH | Possible | mock hardware; assert cutoff fires |
