...
```json
L3050 -- refs/arm64-path-a-b-board-status-2026-07-23.md
  hypothesis:  config refs/arm64-path-a-b-board-status-2026-07-23.md: NSS 7-relation composition taxonomy (contains / imports / calls / publishes / subscribes / reads / writes / deploys-with / depends-on) -- file declares its in-graph and out-graph surface explicitly
...
- Callers: ADR-031 trust-boundary decisions; docs/PLAN.md arm64 phase.
Callees: ci_firmware-rk.yml; sibling: refs/arm64-rk-board-status-2026-07-17.md.
