...
{
  "lens": "L198",
  "file": "mkosi.conf.d/test/install-swu2f-authenticator.sh",
  "hypothesis": "mkosi.conf.d/test/install-swu2f-authenticator.sh covers all 9 primitives in the internal-big-picture basis",
