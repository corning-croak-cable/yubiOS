...
| `quay.io/fedora/fedora-bootc:45` (multi-arch INDEX) | `sha256:7e6d2a54ab590c7a206a7947238d7b517ea2005b2c6c4fab191471aaa57fccd5` | **Containerfile `FROM` base.** OCI image index; auto-resolves per arch. Re-resolved 2026-08-01. Refresh with `fetch-fedora-bootc-manifest`. |
