...
| `yubi-OS/bcvk` | `bootc-dev/bcvk` | `v0.18.0` | `2d86c4cb3c82db57814558bd577d97a2ac6174ca` | `a9303e77dc902a0ff3b547103a7511b5164a450b` | `yubios` branch: release plus yubiOS swtpm/swu2f support (former pin), native-to-disk installer (PR #1), and YubiKey USB passthrough for ephemeral VMs (PR #2), merged together; component validation and VM harness. |
...
| `quay.io/fedora/fedora-bootc:45` (multi-arch INDEX) | `sha256:bc2541d1ad3b6dc4233e909a90ee385b543d78bfe4b42f7c42b2d52b39a1fcac` | **Containerfile `FROM` base.** OCI image index; auto-resolves per arch. Re-resolved 2026-07-26. Refresh with `fetch-fedora-bootc-manifest`. |
