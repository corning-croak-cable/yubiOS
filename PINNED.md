...
| `quay.io/fedora/fedora-bootc:45` (multi-arch INDEX) | `sha256:9153b0fc9db4c7008c1c33d0795a2666a8eb43bb6fc407f9a21ed0d28a6dc2db` | **Containerfile `FROM` base.** OCI image index; auto-resolves per arch. Re-resolved 2026-07-21. Refresh with `fetch-fedora-bootc-manifest`. |
