...
| `yubi-OS/bcvk` | `bootc-dev/bcvk` | `v0.18.0` | `2d86c4cb3c82db57814558bd577d97a2ac6174ca` | `45be63ddf7516ae82fd97b80ba92bd87ccc3a916` | `yubios` branch: release plus yubiOS swtpm/swu2f support (former pin), native-to-disk installer (PR #1), and YubiKey USB passthrough for ephemeral VMs (PR #2), merged together; component validation and VM harness. |
...
| `quay.io/fedora/fedora-bootc:45` (multi-arch INDEX) | `sha256:a82b0685ccda242e0eb2a368672f060022bec212f262f9664615bb90b9ea3999` | **Containerfile `FROM` base.** OCI image index; auto-resolves per arch. Re-resolved 2026-07-24. Refresh with `fetch-fedora-bootc-manifest`. |
