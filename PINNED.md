...
| `quay.io/fedora/fedora-bootc:45` (multi-arch INDEX) | `sha256:5f1f299e76959c3707d27bcf7b2df9f46f9a64044bff03a148c3eadb3e9c32cc` | **Containerfile `FROM` base.** OCI image index; auto-resolves per arch. Re-resolved 2026-07-17. Refresh with `fetch-fedora-bootc-manifest`. |
