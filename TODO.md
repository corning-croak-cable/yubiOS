...
- [ ] U-Boot console/shell authentication gate (FIDO2/U2F) — idea only, needs an ADR before scoping; corrects a raw chat-attachment sketch that used invented APIs. See FUTURE.md § Idea (unscoped) — U-Boot console/shell authentication gate.
