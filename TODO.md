...
- [x] Separate installer and TF-A signature-bearing envelopes from canonical unsigned subjects in the blocking ARM64 comparisons; retain both envelope digests without treating random keys/signatures as equality subjects.
