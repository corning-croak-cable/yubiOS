...
# ---------- Build ----------
output_path = Path("/tmp/v4push_active/learned-latent-curves-2026-08-06-v4.pdf")
...
table_data = [
    ...
    ["S&sup2; (sphere) &mdash; positive control",
     "+0.9995 &plusmn; 0.0001",
     "-0.0825 &plusmn; 0.0840",
     "p &lt; 10<sup>-55</sup>"],
]
...
figC2 = "/tmp/v4push_active/chart-synthetic-manifold-v4-2026-08-06.png"
