...
| D6 | [#214](https://github.com/yubi-OS/yubiOS/pull/214) | **injective-mapping** — the honest "Excel sheet": 2286 items → unique keyed rows; measurement space has 176 classes (largest: 795 items at full coverage); injectivity ladder 176 → 252 → 318 → 2286; qualia coordinates inadmissible per the membership condition | [`tools/injective-mapping/`](../tools/injective-mapping/) |
