...
Generated by `fit-full-curve-map.py` on **2026-08-07 20:12:35 UTC**.
...
- **Items fitted:** **85** corpus items (cycle-1 / initial-state coverage).
- **Basis:** 9 primitives (`internal-big-picture` 9-primitive variant).
- **Saturated** (all 9 covered): **21/85**
- **Sparse** (≤ 2 covered): **8/85**
- **Average coverage:** **7.09 / 9**
- **PC1 explained variance:** **0.4439**
- **PC1+PC2 explained variance:** **0.6543** (gate: ≥ 0.40 → PASS)
- **High-residual skills** (> 1.5× median residual): **32/85**
