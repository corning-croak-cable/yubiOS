...
{
  "lens": "L521",
  "file": "usr/lib/yubiOS/chipsec/run-firstboot-check.sh",
  "hypothesis": "usr/lib/yubiOS/chipsec/run-firstboot-check.sh covers all 9 primitives in the internal-big-picture basis",
