...
{
  "lens": "L400",
  "file": "skills/docker-setup-qemu-action/SKILL.md",
  "hypothesis": "skills/docker-setup-qemu-action/SKILL.md covers all 9 primitives in the internal-big-picture basis",
