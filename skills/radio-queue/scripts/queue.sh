...
This file's lens is **L500** in `lenses.json` (score 6/50, verdict **NO**, k=1/9). Full experiment: hypothesis `skills/radio-queue/scripts/queue.sh covers all 9 primitives in the internal-big-picture basis`, method `9-D primitive binarization (purpose, examples, guidelines, constraints, verifica...`. See root `new-ideas-2026-08-12.md` for the cycle-3 summary.
