...
{
  "lens": "L447",
  "file": "skills/radio-queue/scripts/queue_player.sh",
  "hypothesis": "skills/radio-queue/scripts/queue_player.sh covers all 9 primitives in the internal-big-picture basis",
