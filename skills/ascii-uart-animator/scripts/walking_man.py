...
{
  "lens": "L370",
  "file": "skills/ascii-uart-animator/scripts/walking_man.py",
  "hypothesis": "skills/ascii-uart-animator/scripts/walking_man.py covers all 9 primitives in the internal-big-picture basis",
