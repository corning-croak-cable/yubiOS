...
{
  "lens": "L366",
  "file": "skills/ascii-uart-animator/scripts/bouncing_ball_ansi.py",
  "hypothesis": "skills/ascii-uart-animator/scripts/bouncing_ball_ansi.py covers all 9 primitives in the internal-big-picture basis",
