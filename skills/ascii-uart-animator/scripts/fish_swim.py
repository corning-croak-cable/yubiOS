...
{
  "lens": "L368",
  "file": "skills/ascii-uart-animator/scripts/fish_swim.py",
  "hypothesis": "skills/ascii-uart-animator/scripts/fish_swim.py covers all 9 primitives in the internal-big-picture basis",
