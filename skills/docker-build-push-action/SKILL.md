...
{
  "lens": "L395",
  "file": "skills/docker-build-push-action/SKILL.md",
  "hypothesis": "skills/docker-build-push-action/SKILL.md covers all 9 primitives in the internal-big-picture basis",
