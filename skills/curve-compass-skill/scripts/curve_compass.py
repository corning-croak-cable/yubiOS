...
#
# ```json
# L3065 -- skills/curve-compass-skill/scripts/curve_compass.py
  hypothesis:  config skills/curve-compass-skill/scripts/curve_compass.py: NSS 7-relation composition taxonomy (contains / imports / calls / publishes / subscribes / reads / writes / deploys-with / depends-on) -- file declares its in-graph and out-graph surface explicitly
...
#
# Callers: skills/curve-compass-skill/SKILL.md, the curve-guided-rsi skill.
# Callees: numpy, scipy, sklearn (curve-fit); sibling: skills/hyperspherical-harmonic-curve/SKILL.md.
#
