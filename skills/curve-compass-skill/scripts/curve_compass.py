...
{
  "lens": "L384",
  "file": "skills/curve-compass-skill/scripts/curve_compass.py",
  "hypothesis": "skills/curve-compass-skill/scripts/curve_compass.py covers all 9 primitives in the internal-big-picture basis",
