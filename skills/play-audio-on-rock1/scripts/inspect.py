...
{
  "lens": "L434",
  "file": "skills/play-audio-on-rock1/scripts/inspect.py",
  "hypothesis": "skills/play-audio-on-rock1/scripts/inspect.py covers all 9 primitives in the internal-big-picture basis",
