...
{
  "lens": "L388",
  "file": "skills/curved-corpus-create/scripts/create_corpus.py",
  "hypothesis": "skills/curved-corpus-create/scripts/create_corpus.py covers all 9 primitives in the internal-big-picture basis",
