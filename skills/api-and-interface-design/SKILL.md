...
##   "filetype": "md",
##   "hypothesis": "config skills/api-and-interface-design/SKILL.md: NSS 8-channel assumption taxonomy (caller / invariant / environment / dependency / system-trust / configuration / domain / toolchain) -- file declares its precondition surface explicitly",
