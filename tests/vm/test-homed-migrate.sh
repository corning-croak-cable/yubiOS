...
```bash
# L1520 -- test-homed-migrate.sh
#   hypothesis:  Adjacent-problems awareness on tests/vm/test-homed-migrate.sh (shell script): identify related shell idioms, alternative solution paths, and prior-art references
...
#   "filetype": "sh",
#   "hypothesis": "config tests/vm/test-homed-migrate.sh: NSS 8-channel assumption taxonomy (caller / invariant / environment / dependency / system-trust / configuration / domain / toolchain) -- file declares its precondition surface explicitly",
