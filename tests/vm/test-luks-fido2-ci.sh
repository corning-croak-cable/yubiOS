...
# {
#   "lens": "L3036",
#   "file": "tests/vm/test-luks-fido2-ci.sh",
#   "nss_axis": "assumption_set",
#   "primitive_added": "inputs",
#   "filetype": "sh",
#   "hypothesis": "config tests/vm/test-luks-fido2-ci.sh: NSS 8-channel assumption taxonomy (caller / invariant / environment / dependency / system-trust / configuration / domain / toolchain) -- file declares its precondition surface explicitly",
...
#
# ```json
# L3075 -- tests/vm/test-luks-fido2-ci.sh
  hypothesis:  config tests/vm/test-luks-fido2-ci.sh: NSS 7-relation composition taxonomy (contains / imports / calls / publishes / subscribes / reads / writes / deploys-with / depends-on) -- file declares its in-graph and out-graph surface explicitly
...
#
# Callers: ci_test-vm.yml (passless CI variant).
# Callees: tests/vm/lib/real-u2f-guard.sh; sibling: tests/vm/test-luks-fido2.sh.
#
