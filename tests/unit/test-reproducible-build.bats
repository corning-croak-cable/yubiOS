...
{
  "lens": "L483",
  "file": "tests/unit/test-reproducible-build.bats",
  "hypothesis": "tests/unit/test-reproducible-build.bats covers all 9 primitives in the internal-big-picture basis",
