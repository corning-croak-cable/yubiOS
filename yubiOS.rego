...
- Reading `yubiOS.rego` (no args) shows usage
- See `docs/ARCHITECTURE.md` for where this file fits in yubiOS


## Verification

- Spot-check by reading `yubiOS.rego` end-to-end against this section's claim
- Run the relevant CI workflow on a draft branch per `docs/CI_MAP.md`


# Changelog: 2026-08-12 -- RSI cycle-4 new-idea experiment (primitive changelog).
